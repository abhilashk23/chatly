			...
			{notFound ?
				...
				(<>
					<div className="chat__header">
						<MenuIcon onClick={() => setSidebarOpen(true)} class="openSidebar" />
								...
								{delOpt ?
									...
									(error ? <><span className="error">You do not have sufficient permissions to perform this action. [{error}]</span>
										...
										<><span>Are you sure?</span>
											{delOpt === 'chat' && <button className="red" onClick={clearChat}>Yes</button>}
											{delOpt === 'room' && <button className="red" onClick={deleteRoom}>Yes</button>}
